...
namespace Pmo\Handlers;

use Psr\Http\Message\ResponseFactoryInterface;
use Psr\Http\Message\ResponseInterface;
use Psr\Http\Message\ServerRequestInterface;
use RuntimeException;
use Pmo\Error\Renderers\HtmlErrorRenderer;
use Pmo\Error\Renderers\JsonErrorRenderer;
use Pmo\Error\Renderers\PlainTextErrorRenderer;
use Pmo\Error\Renderers\XmlErrorRenderer;
...
/**
 * Default Pmo application error handler
 *
...
class ErrorHandler implements ErrorHandlerInterface
{
     ...
     * Pmo's error handling requirements. Consider a fully-feature solution such
